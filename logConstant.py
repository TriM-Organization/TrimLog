...
class PipManage:
    def __init__(self,
                 isPipDetect: bool = False,
                 maxPrintLibCount: int = 20):
        self.working_set = pkg_resources.WorkingSet()
        self.lst = [d for d in self.working_set]  # 本环境下已有内容

        self.isPipDetect = isPipDetect  # 是否自动检测

        self.maxPrintLibCount = maxPrintLibCount  # 打印阈值
    ...
    def pip_detect(self) -> Union[bool, list[Union[dict[str, str]]], list[Union[dict[str, None]]]]:
        """
